...
objeto chamado "Clientes" que contém as referências para estes componentes.
Por fim, o objeto "Clientes" é exportado como o valor padrão do módulo, o que significa que, ao 
importar este módulo noutro lugar, o objeto "Clientes" estará disponível para uso. Isto permite 
que outros módulos acedam aos componentes "Home", "Login" e "Termos" através do objeto "Clientes".
*/
